            ...
            <div className="w-[90%] md:w-3/4 mx-auto my-8 rounded-bl-full space-y-5">
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col justify-content gap-2">
                        ...
                        <p>
                            This page serves to inform website visitors about our policies regarding the collection, use, and disclosure of personal information for individuals who choose to use our service.
                        </p>
                        <p>
                            By using our service, you acknowledge and consent to the collection and use of information as outlined in this policy. The personal information collected is solely intended to enhance and improve the service. We are committed to safeguarding your privacy and will not use or share your information except as specified in this Privacy Policy.
                        </p>
                        <p>
                            The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Anbesa DBS app unless otherwise defined in this Privacy Policy.
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col justify-content gap-2"><p>To enhance your experience while using our service, we may request certain personally identifiable information. This may include, but is not limited to, contact details, phone numbers, names, gender, age, images, and contact lists. Additionally, we may collect postal or residential addresses,
                        ...
                        relatives, geo-location data, occupation, and biometric information.</p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col justify-content "><p>Cookies are files with small amount of data that is commonly used an anonymous unique identifier. These are sent to your browser from the website that you visit and are stored on your device internal memory.</p>
                        ...
                        <ul className="space-y-2">
                            <li className="relative pl-4 before:content-['•'] before:absolute before:left-0 before:text-black">
                        ...
                        <p className="mt-2">We want to inform users of this Service that these third parties have access to your Personal Information. The reason is to perform the tasks assigned to them on our behalf.
                ...
                <div className="space-y-4">
                    ...
                    <ul className="space-y-2">
                        <li className="relative pl-4 before:content-['•'] before:absolute before:left-0 before:text-black">
                            <div className="flex gap-4 items-center font-semibold"><h1>Tel:</h1><p>(+251) 11 662 60 00/60</p></div>

                        </li>
                        <li className="relative pl-4 before:content-['•'] before:absolute before:left-0 before:text-black">
                            <div className="flex gap-4 items-center font-semibold">
                                <h1>Fax:</h1>
                                <p>(+251) 11 662 59 99</p>
                            </div>
                        </li>
                        <li className="relative pl-4 before:content-['•'] before:absolute before:left-0 before:text-black">
                            <div className="flex gap-4 items-center font-semibold">
                                <h1>P.O.Box:</h1>
                                <p>27026/1000 Addis Ababa</p>
                            </div>
                        </li>
                        <li className="relative pl-4 before:content-['•'] before:absolute before:left-0 before:text-black">
                            <div className="flex gap-4 items-center font-semibold">
                                <h1>E-mail:</h1>
                                <p>info@anbesabank.com</p>
                            </div>
                        </li>
